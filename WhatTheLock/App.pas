...
type
  ...
  class var
    OCoCreateInstance:
    function(const _para1: TCLSID; _para2: IUnknown; _para3: DWORD; const _para4: TIID; out _para5): HRESULT; stdcall;
    OTaskDialogIndirect:
    function(AConfig: PTASKDIALOGCONFIG; Res: PInteger; ResRadio: PInteger; VerifyFlag: PBOOL): HRESULT; stdcall;
    ...
    class function HCoCreateInstance(const _para1: TCLSID; _para2: IUnknown; _para3: DWORD; const _para4: TIID; out _para5: Pointer): HRESULT; stdcall; static;
...
class function TApp.HCoCreateInstance(const _para1: TCLSID; _para2: IUnknown; _para3: DWORD; const _para4: TIID; out _para5: Pointer): HRESULT; stdcall;
var
  FileOperation: TFileOperation;
begin
